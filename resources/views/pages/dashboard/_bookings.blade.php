    ...
    <div class="row">
        ...
        <div class="col-lg-2 col-md-3">
            <ul class="info_booking">
                ...
                <li><strong>Booked on</strong> Sat. 23 APR. 2022</li>
            </ul>
        </div>
        <div class="col-lg-2 col-md-2">
...
<div class="strip_booking">
    <div class="row">
        ...
        <div class="col-lg-6 col-md-5">
            <h3 class="hotel_booking">Louvre Museum<span>2 Adults / 2 Childs</span></h3>
        </div>
        <div class="col-lg-2 col-md-3">
            <ul class="info_booking">
                <li><strong>Booking id</strong> 23442</li>
                <li><strong>Booked on</strong> Sat. 20 APR. 2022</li>
            </ul>
        </div>
        <div class="col-lg-2 col-md-2">
            <div class="booking_buttons">
...
<div class="strip_booking">
    <div class="row">
        ...
        <div class="col-lg-6 col-md-5">
            <h3 class="hotel_booking">Tour Eiffel<span>2 Adults</span></h3>
        </div>
        <div class="col-lg-2 col-md-3">
            <ul class="info_booking">
                <li><strong>Booking id</strong> 23442</li>
...
<div class="strip_booking">
    <div class="row">
        ...
        <div class="col-lg-6 col-md-5">
            <h3 class="hotel_booking">Orly Airport<span>2 Adults / 2Childs</span></h3>
        </div>
        <div class="col-lg-2 col-md-3">
            <ul class="info_booking">
                <li><strong>Booking id</strong> 23442</li>
